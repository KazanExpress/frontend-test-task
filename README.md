...
Откройте bash (Linux \ MacOs) Cmd (Window)
```
git clone git@github.com:thinkjazz/frontend-test-task.git
```
Установите зависимости
```
npm install
```
### Старт проекта для разработки по адресу http://localhost:8080/
```
npm run serve
```

### Компилируется для продакшна
```
npm run build
```
